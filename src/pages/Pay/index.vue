      ...
      <div class="checkout-steps">
        ...
        <div class="submit">
          <!-- <router-link class="btn" to="/paysuccess">立即支付</router-link> -->
            <el-button type="text" @click="open" class="btn">立即支付</el-button>
        </div>
        <div class="otherpay">
          <div class="step-tit">
            <h5>其他支付方式</h5>
       ...
       async open() {
        ...
        this.$alert(`<img src='${url}'>`, '请你微信支付', {
          ...
          beforeClose:(action,instance,done)=>{
            // action:按钮cancel or confirm
            // instance:message组件实例
            // done:关闭message弹窗
            if (action=='cancel') {
              alert('请联系管理员')
              // 清除定时器
